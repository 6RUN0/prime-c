              ...
              <div class="no_stretch kl-location">
                ...
                {if $k.inv || $comments_count}
                  <div class="kl-inv-comm">
                    {if $k.inv}<img src="{$kb_host}/img/sta_gang.png"  alt="I:"  width="9px" height="9px" /> {$k.inv}{/if}
                    {if $comments_count}<span {if  !$k.commentcount}style="visibility: hidden"{/if}><img src="{$kb_host}/img/comment_white.gif" alt="C:" width="15px" height="15px" /> {$k.commentcount}</span>{/if}
                  </div>
                {/if}
              <div class="kl-date">
                {if $daybreak}
